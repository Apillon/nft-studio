<template>
  <div class="animation-loader">
    <svg :width="size" :height="size" viewBox="0 0 220 220" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path :d="dotRight" :fill="colors.black" />
      <path :d="dotCenter" :fill="colors.black" />
      <path :d="dotLeft" :fill="colors.black" />
      <path :d="triangleLeft" :fill="colors.black" />
      <path :d="triangleRight" :fill="colors.black" />
    </svg>
  </div>
</template>
