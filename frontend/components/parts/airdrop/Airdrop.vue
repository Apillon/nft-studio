  ...
  <div class="w-full my-12 mx-auto">
    <div class="flex justify-between gap-8">
      <div class="mb-8 max-w-2xl lg:pr-10">
        ...
        <div>
          Use multiple distribution methods—email, wallet address, or public link. All NFTs are sent
          from your Apillon-hosted collection, so make sure you’ve got enough supply left.
        </div>
      </div>
